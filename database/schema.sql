...
INSERT INTO app_user(user_name, password, salt, is_admin) VALUES ('KevinC', 'Z+6dbfgKW9yOzFOoTOkL2A==', 'o7BHFhCTGHVmsaQ/aV/eMtPLAKwjny7PfHNHYxNurH8jNTB98T6GXTKttD2Q/Oqkpp++6kqt0x1wwtk/dhYHslKuROy4z3exR3uKDEHXW+SYNXlGLpW5niA56ej2Jc/yCR5liYjKko8U3cGNuUFp/jp5bpfiLC1qif55iji0qZc=', TRUE);
INSERT INTO app_user(user_name, password, salt, is_admin) VALUES ('AlexisT', 'ur6k/xfmGaYHjehKRyHM7w==', 'VZnfAUcRVK1W+5d62n6EBtmjN5o8VcdaeKSKiyJ/ufiWi4zcWlAP+4OqWjwViZCWUWTVETdz0RCaEXeYBFtVpcAFqCslnPPpETsIvdHl+Vf1pSudvqOl47y++QwQ0KAJa/DILzgqxe1mLoMfYwE0X8BEKgRzHAaBFBwXHE+uUTs=', TRUE);
INSERT INTO app_user(user_name, password, salt, is_admin) VALUES ('KellyM', 'abCu2Z/ss3lg15kZHH9a6A==', 'f1ekHQbXYiuAIvWspr/AkYwqewm/zGAgq7MiyLbI5Ddzw4bt8LZEh/H0eJ9BxbHuxF0UTSbMzivyuxhG0Uyd7ulEDH+DHIw389AD6BhK2A5KnDghFDneLj+hayKeG5ak/BHWBqInOoE2oMZrh/fiO5mve5U8PGhXePuwWDKris8=', TRUE);
INSERT INTO app_user(user_name, password, salt, is_admin) VALUES ('AdamG', 'QAHQxJ5fL70bj4KA1XqOEQ==', 'Kl9CB9BA1QQHdSBpDhafg8rdyWkhlf5s7jxbCKFURNQB26/OROT+K714NBADlkJBj009M+37PlPe+2y50I+yJbD8x0ZlonRHuRYJ9ewnHLaWrUJJLWICqCoTXOLfOuIl8jcXNH2Zov2mF1vKIEsdvBGOqC1txkLHUTjtidOcVCo=', TRUE);
INSERT INTO app_user(user_name, password, salt, is_admin) VALUES ('Homer', 'cmcu3KkNgSk514vNbZZYgQ==', 'vgjcnfDxbIe7/zq4PuX30UVPuPFW6d6Z2EQ3YouCWtwpJ8uAMxcdTmQ2x7dOO53TvPCmn1CIBQwzHiagy/MT2OI3fDtrXpNAS2PvpTok4//13EqIrrp6EB765ke/gQAu8PTjxyJsKRbbUT3M+cTdbr/B4XG+Yz83oXd2wJb/62Y=', FALSE);
INSERT INTO app_user(user_name, password, salt, is_admin) VALUES ('Steggy', '9dXOj9vfIaFgatNyNy+riw==', 'WjI5+XnN66U8vytiEr0MX+JEegKz4KfrxLKUxanGGbf1+H9VKGYQ+WYNfY84/iKVvnIkHIPAyYYYe6mK9nDKGy4EdY58/qVJpRd1ygdvC+1vfBFA9N1AEZcodUfRXwImNa0jrfYAoepR7XNwABApyv046UF+0yyTCUt/yGn7DmE=', FALSE);
